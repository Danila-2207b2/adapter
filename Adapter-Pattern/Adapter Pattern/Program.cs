...
internal class Program
{
    ...
    {
        ComputerGame computerGame = new ComputerGame(name:"Euro Truck Simulator",pegiAgeRating:PegiAgeRating.P18,budgetInMillionsOfDollars:100,minimumGpuMemoryInMegabytes:8000,diskSpaceNeededInGB:300,ramNeededInGB:32,coresNeeded:8,coreSpeedInGhz:6.4);
